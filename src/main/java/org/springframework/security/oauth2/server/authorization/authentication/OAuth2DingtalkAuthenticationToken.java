...
public class OAuth2DingtalkAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	 ...
	 */
	public OAuth2DingtalkAuthenticationToken(Authentication clientPrincipal, Map<String, Object> additionalParameters,
			String appid, String code, String scope, String remoteAddress, String sessionId, String state,
			String binding) {
		super(OAuth2DingtalkAuthenticationToken.DINGTALK, clientPrincipal, additionalParameters);
