...
public interface DingtalkService {
	 ...
	 * 拦截处理此异常
	 */
	DingtalkProperties.Dingtalk getDingtalkByAppid(String appid) throws OAuth2AuthenticationException;
	 ...
	 * 拦截处理此异常
	 */
	DingtalkTokenResponse getAccessTokenResponse(String appid, String code, String state, String binding,
